<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="NameMyFee.login" %>
    ...
    <div class="horizontal-main bg-dark-transparent clearfix">
        <div class="horizontal-mainwrapper container clearfix">
            ...
            <div class="desktoplogo-1">
                <a href="home_page.aspx"><asp:Image ID="Image1" runat="server" src="../assets/images/logo3.png" alt="" Height="60" Width="250" /></a>
            </div>
            <!--Nav-->
                ...
                <div class="single-page">
                    <div class="col-lg-5 col-xl-4 col-md-6 d-block mx-auto">
                        <div class="wrapper wrapper2">
                            <form id="login" class="card-body" tabindex="500" runat="server">
                                <div class="mail">
                                    <asp:TextBox id="mail" runat="server"/>
                                    <label>Mail</label>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter the Mail" ControlToValidate="mail" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                                <div class="passwd">
                                ...
                                <p class="mb-2"><a href="login.aspx">Forgot Password</a></p>
                                <p class="text-dark mb-0">Don't have account?<a href="register.aspx" class="text-primary ml-1">Sign UP</a></p>
                            </form>
