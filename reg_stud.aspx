<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reg_stud.aspx.cs" Inherits="NameMyFee.reg_stud" %>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-md-12 register-right">
                            <ul class="nav nav-tabs nav-justified mb-5 p-2 border" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active m-1" href="reg_stud.aspx" aria-selected="true">Student</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link m-1" href="register.aspx" aria-selected="false">University</a>
                                </li>
                            </ul>
                                    ...
                                    <div class="single-page w-100  p-0">
                                        <div class="wrapper wrapper2">
                                            <form id="Register" runat="server" class="card-body" tabindex="500">
                                                <h3 class="pb-1">Register as a Student</h3>
                                                <div class="f_name">
                                                    <asp:TextBox id="name" runat="server"/>
                                                   <label>First Name</label>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter your First Name" ControlToValidate="name" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>                                               
                                                <div class="l_name">
                                                    <asp:TextBox id="l_name" runat="server"/>
                                                   <label>Last Name</label>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter the your Last Name" ControlToValidate="l_name" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div> 
                                                <div class="email">
                                                    <asp:TextBox id="email" runat="server" TextMode="Email" />
                                                    <label>Email</label>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter the Email" ControlToValidate="email" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="passwd">
                                                    <asp:TextBox id="password" runat="server" TextMode="Password" />
                                                    <label>Password</label>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please Enter the Password" ControlToValidate="password" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>

                                                <div class="passwd">
                                                    <asp:TextBox id="TextBox2" runat="server" TextMode="Date" />
                                                    <label>Date Of Birth</label>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="Please Enter the Date" ControlToValidate="password" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>

                                                <div class="mob">
                                                    <asp:TextBox id="mobile" runat="server"/>
                                                    <label>Contact Number</label>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please Enter the Contact Number" ControlToValidate="mobile" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="nationality">
                                                    <asp:TextBox id="nationality" runat="server"/>
                                                    <label>Nationality</label>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Please Enter the Nationality" ControlToValidate="nationality" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="residence">
                                            ...
                                            <asp:ListItem >Malaysia</asp:ListItem>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Please Enter the Country of Residence" ControlToValidate="DropDownList1" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="city">
                                                    <asp:TextBox id="city" runat="server"/>
                                                    <label>City</label>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Please Enter the City" ControlToValidate="city" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>
